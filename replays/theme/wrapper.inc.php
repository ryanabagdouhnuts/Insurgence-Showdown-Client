...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?1179d3d8"></script>
	<script src="//play.pokemonshowdown.com/js/battledata.js?1e44efb2"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex-mini.js?0.731377547983318"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex-mini-bw.js?0.7628703053059855"></script>
	<script src="//play.pokemonshowdown.com/data/graphics.js?cfaf5f7f"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex.js?28936698"></script>

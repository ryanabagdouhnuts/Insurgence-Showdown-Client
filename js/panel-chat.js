...
_this=_PSRoom.call(this,options)||this;_this.classType='chat';_this.users={};_this.userCount=0;_this.pmTarget=null;_this.challengeMenuOpen=false;_this.challengingFormat=null;_this.challengedFormat=null;
...
preact.h("button",{type:"submit","class":"button disabled"},preact.h("strong",null,"Challenge"))," ",
preact.h("button",{name:"cmd",value:"/cancelchallenge","class":"button"},"Cancel"))):
...
preact.h("button",{type:"submit","class":"button disabled"},preact.h("strong",null,"Accept"))," ",
...
this.subscription=this.props.room.subscribe(function(msg){
if(!msg)return;
var tokens=BattleTextParser.parseLine(msg);
switch(tokens[0]){
case'title':
